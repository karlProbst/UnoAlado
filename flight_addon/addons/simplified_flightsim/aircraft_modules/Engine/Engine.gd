...
@onready var RayCastb = get_parent().get_node("RayCastb")
@onready var RayCastf = get_parent().get_node("RayCastf")

@onready var fiatwf = get_parent().get_node("FIATUNO/Sketchfab_model/fiat uno slim 2001_fbx/RootNode/Wheel_001")
@onready var fiatwb = get_parent().get_node("FIATUNO/Sketchfab_model/fiat uno slim 2001_fbx/RootNode/Wheel")
@onready var lights = get_parent().get_node("FIATUNO/Lights")
...
func _process(delta):
	if(RayCastb.is_colliding()):
		fiatwf.rotate_x(current_power*delta*10)
	if(RayCastf.is_colliding()):
		fiatwb.rotate_x(current_power*delta*10)
